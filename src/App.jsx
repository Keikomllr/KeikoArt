...
function App() {
  ...
  return (
    <>
       ...
       <Hero hero={hero} /> {/* All Hero Objects*/}
          {/*Write like below when you chose objects.
          <Hero {...hero} />
          <Hero headline={headline} buttonLabel={buttonLabel} /> */}
